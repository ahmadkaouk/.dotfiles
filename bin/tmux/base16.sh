...
tm_tunes="#[bg=$base00,fg=$base0D]  #(osascript -l JavaScript ~/.config/bin/applescripts/tunes.js)"
tm_battery="#[bg=$base00]   #(~/.config/bin/battery_indicator.sh)  "
tm_date="#[default,bg=$base00,fg=$base0C] %R"
tm_host="#[fg=$base0E,bg=$base00] #(echo $USER) "
