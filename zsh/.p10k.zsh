# Generated by Powerlevel10k configuration wizard on 2021-03-16 at 08:22 CET.
...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%1F%B'   # green foreground
      local   modified='%1F%B'  # yellow foreground
      local  untracked='%1F%B'   # blue foreground
